...
func (x *SoNTRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SoNTRequest) ProtoMessage() {}

func (x *SoNTRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculatorpb_calculator_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SoNTRequest.ProtoReflect.Descriptor instead.
func (*SoNTRequest) Descriptor() ([]byte, []int) {
	return file_calculatorpb_calculator_proto_rawDescGZIP(), []int{2}
}

func (x *SoNTRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *SoNTReqonse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SoNTReqonse) ProtoMessage() {}

func (x *SoNTReqonse) ProtoReflect() protoreflect.Message {
	mi := &file_calculatorpb_calculator_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SoNTReqonse.ProtoReflect.Descriptor instead.
func (*SoNTReqonse) Descriptor() ([]byte, []int) {
	return file_calculatorpb_calculator_proto_rawDescGZIP(), []int{3}
}

func (x *SoNTReqonse) GetResult() int32 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x32, 0x22, 0x24, 0x0a, 0x0a, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x25, 0x0a, 0x0b, 0x53, 0x6f, 0x4e, 0x54, 0x52,
	...
	,
...
var file_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*SoNTRequest)(nil), // 2: calculator.SoNTRequest
	(*SoNTReqonse)(nil), // 3: calculator.SoNTReqonse
}
var file_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	2, // 1: calculator.CalculatorService.SoNT:input_type -> calculator.SoNTRequest
	1, // 2: calculator.CalculatorService.Sum:output_type -> calculator.SumReponse
	3, // 3: calculator.CalculatorService.SoNT:output_type -> calculator.SoNTReqonse
...
type CalculatorServiceClient interface {
	...
	SoNT(ctx context.Context, in *SoNTRequest, opts ...grpc.CallOption) (CalculatorService_SoNTClient, error)
}
...
func (c *calculatorServiceClient) SoNT(ctx context.Context, in *SoNTRequest, opts ...grpc.CallOption) (CalculatorService_SoNTClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CalculatorService_serviceDesc.Streams[0], "/calculator.CalculatorService/SoNT", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorServiceSoNTClient{stream}
...
type CalculatorService_SoNTClient interface {
	Recv() (*SoNTReqonse, error)
	grpc.ClientStream
}

type calculatorServiceSoNTClient struct {
	grpc.ClientStream
}

func (x *calculatorServiceSoNTClient) Recv() (*SoNTReqonse, error) {
	m := new(SoNTReqonse)
...
type CalculatorServiceServer interface {
	...
	SoNT(*SoNTRequest, CalculatorService_SoNTServer) error
}
...
func (*UnimplementedCalculatorServiceServer) SoNT(*SoNTRequest, CalculatorService_SoNTServer) error {
	return status.Errorf(codes.Unimplemented, "method SoNT not implemented")
}
...
func _CalculatorService_SoNT_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SoNTRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculatorServiceServer).SoNT(m, &calculatorServiceSoNTServer{stream})
}

type CalculatorService_SoNTServer interface {
	Send(*SoNTReqonse) error
	grpc.ServerStream
}

type calculatorServiceSoNTServer struct {
	grpc.ServerStream
}

func (x *calculatorServiceSoNTServer) Send(m *SoNTReqonse) error {
...
var _CalculatorService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SoNT",
			Handler:       _CalculatorService_SoNT_Handler,
			ServerStreams: true,
		},
	},
